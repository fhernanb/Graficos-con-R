...
##  [1] Rcpp_0.12.6     bookdown_0.2.5  digest_0.6.10  
##  [4] rprojroot_1.1   mime_0.5        R6_2.1.2       
##  [7] xtable_1.8-2    backports_1.0.4 magrittr_1.5   
## [10] evaluate_0.10   stringi_1.1.1   rstudioapi_0.6 
## [13] miniUI_0.1.1    rmarkdown_1.2   tools_3.3.2    
## [16] stringr_1.0.0   shiny_0.13.2    httpuv_1.3.3   
...
\KeywordTok{plot}\NormalTok{(}\KeywordTok{density}\NormalTok{(datos$peso), }\DataTypeTok{main=}\StringTok{'Densidad para el peso corporal'}\NormalTok{,}
     \DataTypeTok{xlab=}\StringTok{'Peso corporal (kg)'}\NormalTok{, }\DataTypeTok{ylab=}\StringTok{'Densidad'}\NormalTok{, }\DataTypeTok{lwd=}\DecValTok{3}\NormalTok{)}
...
\KeywordTok{plot}\NormalTok{(den.hom, }\DataTypeTok{xlim=}\KeywordTok{c}\NormalTok{(}\DecValTok{20}\NormalTok{, }\DecValTok{120}\NormalTok{), }
     ...
     \DataTypeTok{xlab=}\StringTok{'Peso corporal (kg)'}\NormalTok{, }\DataTypeTok{lwd=}\DecValTok{3}\NormalTok{, }\DataTypeTok{col=}\StringTok{'blue'}\NormalTok{)}
\KeywordTok{lines}\NormalTok{(den.muj, }\DataTypeTok{lwd=}\DecValTok{3}\NormalTok{, }\DataTypeTok{col=}\StringTok{'red'}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{figure}[htbp]
\centering
\includegraphics{Graficos_con_R_files/figure-latex/bla-1.pdf}
\caption{\label{fig:bla}Densidad para la variable peso en la izquierda,
