...
\BeginKnitrBlock{rmdnote}
Una buena práctica es crear una copia del objeto \texttt{par} con otro
nombre para luego recuperar la configuración inicial.
\EndKnitrBlock{rmdnote}
...
Este parámetro sirve para modficar el color del fondo donde se va a
dibujar.
...
\caption{\label{fig:par1}Densidad de una normal estándar.}
\end{figure}
