...
\section{Dibujar varios QQplot en una misma
figura}\label{dibujar-varios-qqplot-en-una-misma-figura}
...
\KeywordTok{qqline}\NormalTok{(m1, }\DataTypeTok{col=}\StringTok{'seagreen4'}\NormalTok{)}
...
\section{Dibujar varias densidades en una misma
figura}\label{dibujar-varias-densidades-en-una-misma-figura}
