...
\KeywordTok{boxplot}\NormalTok{(}\DataTypeTok{x=}\NormalTok{datos$altura, }\DataTypeTok{xlab=}\StringTok{'Altura (cm)'}\NormalTok{, }\DataTypeTok{horizontal=}\OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
boxplots para la variable precio de los apartamentos usados en Medellín;
en el primero de ellos se diferencia por la variable balcón y en el
...
\KeywordTok{par}\NormalTok{(}\DataTypeTok{mfrow=}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{))}
\KeywordTok{boxplot}\NormalTok{(precio ~}\StringTok{ }\NormalTok{balcon, }\DataTypeTok{data=}\NormalTok{datos,}
        \DataTypeTok{col=}\KeywordTok{c}\NormalTok{(}\StringTok{'lightblue'}\NormalTok{, }\StringTok{'pink'}\NormalTok{),}
        \DataTypeTok{xlab=}\StringTok{'¿Tiene balcón?'}\NormalTok{,}
        \DataTypeTok{ylab=}\StringTok{'Precio (millones $)'}\NormalTok{)}

\KeywordTok{boxplot}\NormalTok{(precio ~}\StringTok{ }\NormalTok{ubicacion *}\StringTok{ }\NormalTok{parqueadero,}
        ...
        \DataTypeTok{subset=}\NormalTok{ubicacion %in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{'laureles'}\NormalTok{, }\StringTok{'aburra sur'}\NormalTok{),}
...
\caption{\label{fig:boxplots2}Boxplot para la variable altura.}
\end{figure}
...
pero incluyendo información de variables adicionales.
...
\NormalTok{url <-}\StringTok{ 'https://tinyurl.com/hwhb769'}
\NormalTok{datos <-}\StringTok{ }\KeywordTok{read.table}\NormalTok{(url, }\DataTypeTok{header=}\NormalTok{T)}
\NormalTok{subdat <-}\StringTok{ }\KeywordTok{subset}\NormalTok{(datos, ubicacion ==}\StringTok{ 'centro'}\NormalTok{)}
...
con los argumentos más usuales se muestran a continuación.
...
\NormalTok{f1 <-}\StringTok{ }\KeywordTok{kde2d}\NormalTok{(}\DataTypeTok{x=}\NormalTok{datos$peso, }\DataTypeTok{y=}\NormalTok{datos$altura, }\DataTypeTok{n=}\DecValTok{5}\NormalTok{)}
\NormalTok{f2 <-}\StringTok{ }\KeywordTok{kde2d}\NormalTok{(}\DataTypeTok{x=}\NormalTok{datos$peso, }\DataTypeTok{y=}\NormalTok{datos$altura, }\DataTypeTok{n=}\DecValTok{50}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{interaction.plot}\NormalTok{(}\DataTypeTok{response=}\NormalTok{dt$tolerance,}
                 \DataTypeTok{x.factor=}\NormalTok{dt$time, }\DataTypeTok{col=}\DecValTok{1}\NormalTok{:}\DecValTok{8}\NormalTok{, }\DataTypeTok{lwd=}\DecValTok{2}\NormalTok{,}
                 \DataTypeTok{trace.factor=}\NormalTok{dt$id, }\DataTypeTok{las=}\DecValTok{1}\NormalTok{, }\DataTypeTok{lty=}\DecValTok{1}\NormalTok{, }
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot}\NormalTok{(}\DataTypeTok{x=}\KeywordTok{c}\NormalTok{(-}\DecValTok{5}\NormalTok{, }\DecValTok{5}\NormalTok{), }\DataTypeTok{y=}\KeywordTok{c}\NormalTok{(-}\DecValTok{10}\NormalTok{, }\DecValTok{10}\NormalTok{),    }\CommentTok{# Para crear el lienzo}
...
\KeywordTok{abline}\NormalTok{(}\DataTypeTok{a=}\NormalTok{-}\DecValTok{5}\NormalTok{, }\DataTypeTok{b=}\DecValTok{3}\NormalTok{, }\DataTypeTok{lwd=}\DecValTok{3}\NormalTok{, }\DataTypeTok{col=}\StringTok{'blue'}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{abline}\NormalTok{(}\DataTypeTok{h=}\KeywordTok{c}\NormalTok{(}\DecValTok{5}\NormalTok{, -}\DecValTok{3}\NormalTok{), }\DataTypeTok{v=}\DecValTok{2}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dat <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{t=}\KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{2}\NormalTok{*pi, }\DataTypeTok{by=}\FloatTok{0.1}\NormalTok{))}
\NormalTok{xhrt <-}\StringTok{ }\NormalTok{function(t) }\DecValTok{16}\NormalTok{*}\KeywordTok{sin}\NormalTok{(t)^}\DecValTok{3}
\NormalTok{yhrt <-}\StringTok{ }\NormalTok{function(t) }\DecValTok{13}\NormalTok{*}\KeywordTok{cos}\NormalTok{(t)-}\DecValTok{5}\NormalTok{*}\KeywordTok{cos}\NormalTok{(}\DecValTok{2}\NormalTok{*t)-}\DecValTok{2}\NormalTok{*}\KeywordTok{cos}\NormalTok{(}\DecValTok{3}\NormalTok{*t)-}\KeywordTok{cos}\NormalTok{(}\DecValTok{4}\NormalTok{*t)}
\NormalTok{dat$y <-}\StringTok{ }\KeywordTok{yhrt}\NormalTok{(dat$t)}
\NormalTok{dat$x <-}\StringTok{ }\KeywordTok{xhrt}\NormalTok{(dat$t)}
...
\KeywordTok{barplot}\NormalTok{(}\KeywordTok{table}\NormalTok{(x), }\DataTypeTok{main=}\KeywordTok{bquote}\NormalTok{(lambda ==}\StringTok{ }\NormalTok{.(media)))}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{curve}\NormalTok{(}\KeywordTok{dnorm}\NormalTok{(x, }\DataTypeTok{mean=}\NormalTok{mu, }\DataTypeTok{sd=}\KeywordTok{sqrt}\NormalTok{(vari)), }\DataTypeTok{from=}\DecValTok{130}\NormalTok{, }\DataTypeTok{to=}\DecValTok{170}\NormalTok{,}
      ...
      \DataTypeTok{main=}\KeywordTok{bquote}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"Pdf for a normal with "}\NormalTok{,}
                  ...
                  \NormalTok{sigma^}\DecValTok{2}\NormalTok{, }\StringTok{"="}\NormalTok{, .(vari))))}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{legend}\NormalTok{(}\StringTok{'topleft'}\NormalTok{, }\DataTypeTok{legend=}\KeywordTok{levels}\NormalTok{(iris$Species), }\DataTypeTok{cex=}\FloatTok{0.5}\NormalTok{,}
