...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tabla2 <-}\StringTok{ }\KeywordTok{with}\NormalTok{(datos, }\KeywordTok{table}\NormalTok{(balcon, parqueadero))}
\NormalTok{tabla2}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{Graficos_con_R_files/figure-latex/unnamed-chunk-33-1.pdf}
