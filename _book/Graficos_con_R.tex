...
{\centering \includegraphics{images/instalacion2} 
...
{\centering \includegraphics{images/rlogo} 
...
\KeywordTok{plot}\NormalTok{(}\DataTypeTok{x=}\NormalTok{x, }\DataTypeTok{y=}\NormalTok{x, }\DataTypeTok{main=}\StringTok{'Usando cex=1.4'}\NormalTok{)}

\KeywordTok{par}\NormalTok{(}\DataTypeTok{cex=}\FloatTok{0.6}\NormalTok{)}
\KeywordTok{plot}\NormalTok{(}\DataTypeTok{x=}\NormalTok{x, }\DataTypeTok{y=}\NormalTok{x, }\DataTypeTok{main=}\StringTok{'Usando cex=0.6'}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\section{\texorpdfstring{Parámetro \texttt{cex.axis}
\index{tamaño de los nombres en los ejes}
\index{cex.axis}}{Parámetro cex.axis  }}\label{parametro-cex.axis}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{x <-}\StringTok{ }\NormalTok{-}\DecValTok{3}\NormalTok{:}\DecValTok{3}
\KeywordTok{par}\NormalTok{(}\DataTypeTok{mfrow=}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{), }\DataTypeTok{cex.axis=}\FloatTok{1.4}\NormalTok{)}
\KeywordTok{plot}\NormalTok{(}\DataTypeTok{x=}\NormalTok{x, }\DataTypeTok{y=}\NormalTok{x,}
     ...
     \DataTypeTok{main=}\StringTok{'Usando cex.axis=1.4'}\NormalTok{)}

\KeywordTok{par}\NormalTok{(}\DataTypeTok{cex.axis=}\FloatTok{0.6}\NormalTok{)}
\KeywordTok{plot}\NormalTok{(}\DataTypeTok{x=}\NormalTok{x, }\DataTypeTok{y=}\NormalTok{x,}
     \DataTypeTok{xlab=}\StringTok{'Valores de x'}\NormalTok{, }\DataTypeTok{ylab=}\StringTok{'Valores de y'}\NormalTok{,}
     \DataTypeTok{main=}\StringTok{'Usando cex.axis=0.6'}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Graficos_con_R_files/figure-latex/unnamed-chunk-49-1.pdf}
...
\section{\texorpdfstring{Función \texttt{legend} \index{legend}
\index{leyendas}}{Función legend  }}\label{funcion-legend}

\section{\texorpdfstring{Función \texttt{text} \index{text}
\index{texto}}{Función text  }}\label{funcion-text}

\section{\texorpdfstring{Función \texttt{lines} \index{lines}
\index{líneas}}{Función lines  }}\label{funcion-lines}

\section{\texorpdfstring{Función \texttt{points} \index{points}
\index{puntos}}{Función points  }}\label{funcion-points}

\section{\texorpdfstring{Función \texttt{identify} \index{identify}
\index{identificador}}{Función identify  }}\label{funcion-identify}

\section{\texorpdfstring{Función \texttt{locator}
\index{locator}}{Función locator }}\label{funcion-locator}

\section{\texorpdfstring{Función \texttt{axes} \index{axes}
\index{ejes}}{Función axes  }}\label{funcion-axes}

\section{\texorpdfstring{Función \texttt{title} \index{title}
\index{títulos}}{Función title  }}\label{funcion-title}

\section{\texorpdfstring{Función \texttt{mtext}
\index{mtext}}{Función mtext }}\label{funcion-mtext}
...
\index{rug}}{Función rug }}\label{funcion-rug}
...
\index{rectas}}{Función rect  }}\label{funcion-rect}
