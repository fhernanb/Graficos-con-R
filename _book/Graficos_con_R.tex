...
ejes, éstos no aparecen en el resultado final. En la Figura
\ref{fig:ann} se muestra el gráfico solicitado.
...
dentro de las funciones gráfica.
\EndKnitrBlock{rmdnote}
...
continuación. Observando la Figura \ref{fig:adj} se nota claramente que
cuando \texttt{adj=0.5} la palabra queda centrada mientras que con otros
valores cambia la justificación del texto.
...
puede encontrar una paleta de colores disponibles en \proglang{R}.
...
\begin{figure}[htbp]
\centering
\includegraphics{Graficos_con_R_files/figure-latex/par1-1.pdf}
\caption{\label{fig:par1}Efecto del parámetro \texttt{bg}.}
\end{figure}
