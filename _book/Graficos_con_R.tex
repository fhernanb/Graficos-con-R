...
\chapter{Animaciones básicas}\label{animaciones-basicas}

En este capítulo se presentan algunos ejemplos de cómo crear gráficos
animados.

\section{\texorpdfstring{Función \texttt{segments} \index{segments}
\index{segmentos}}{Función segments  }}\label{funcion-segments-1}
