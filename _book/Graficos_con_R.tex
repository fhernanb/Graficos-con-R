...
Suponga que se tiene la información del número de hombres y mujeres que
sufren de una enfermedad rara en cuatro ciudades importantes del mundo,
a continuación la matriz \texttt{x} con la información recolectada.
...
Para construir un gráfico de puntos para resumir
...
\caption{\label{fig:dotchart2}Ejemplos de los tipos de puntos obtenidos al
variar \texttt{pch}.}
\end{figure}
