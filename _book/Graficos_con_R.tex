...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tabla2 <-}\StringTok{ }\KeywordTok{table}\NormalTok{(datos$balcon, datos$parqueadero)}
\NormalTok{tabla2}
\end{Highlighting}
\end{Shaded}
...
\caption{\label{fig:barra3}Diagrama de barras para el estrato socioeconómico
de los apartamentos usados con las frecuencias relativas sobre las
barras.}
\end{figure}
