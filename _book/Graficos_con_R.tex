...
\hypersetup{
            pdftitle={Gráficos en R usando solo la base},
            colorlinks=true,
            linkcolor=Maroon,
            citecolor=Blue,
            urlcolor=Blue,
...
\title{Gráficos en R usando solo la base}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dt <-}\StringTok{ }\KeywordTok{read.table}\NormalTok{(}\StringTok{"http://www.ats.ucla.edu/stat/r/faq/tolpp.csv"}\NormalTok{,}
