...
```{r symbols1, fig.cap='Diagrama de dispersión con los símbolos circle y squares para incluir más variables.', fig.asp=0.7, fig.width=8}
...
```{r symbols2, fig.cap='Diagrama de dispersión con los símbolos rectangles y stars para incluir más variables.', fig.asp=0.7, fig.width=8}
par(mfrow=c(1, 2))
with(subdat, symbols(x=mt2, y=precio,
...
```{r ex1persp, fig.cap='Superficie generada con `persp` y diferentes valores de theta y phi.', fig.asp=1, fig.width=20}
