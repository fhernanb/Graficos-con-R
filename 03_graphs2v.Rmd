...
La función `sunflowerplot` sirve para crear gráficos de dispersión para dos variables cuantitativas en los cuales hay parejas de puntos repetidos y que no se visualizan bien con la función `plot`. 
