...
plot(c(-10, 10), c(-10, 10), type="n", xlab="", ylab="")
grid(nx=3, ny=3, col="pink", lwd=2, lty="longdash")
```
...
```{r point2, fig.cap='Ejemplos de símbolos personalizados con `pch`.', fig.asp=0.8, fig.width=6}
