...
\section{Descarga e instalación} {#sec:descarga}
...
\section{Apariencia del programa} {#sec:apariencia}
...
\section{Tipos de objetos} {#sec:objetos}
...
\section{Guía de estilo para la escritura en R} {#sec:estilo}
