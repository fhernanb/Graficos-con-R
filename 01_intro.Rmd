...
```{r, echo=F, fig.cap='Robert Gentleman (izquierda) y Ross Ihaka (derecha) creadores de R.', dpi=190, fig.align='center'}
knitr::include_graphics("figures/Robert_Roos.png")
```
...
knitr::include_graphics("figures/instalacion1.png")
```
...
knitr::include_graphics("figures/instalacion2.png")
```
...
knitr::include_graphics("figures/Rpantallazo.png")
```
