...
En el capítulo \@ref(intro) se presenta una introducción breve de R, sus orígenes, la instalación, tipos de objetos y una guía de estilo para escribir en R. En el capítulo \@ref(una_cuanti) se muestra como construir gráficos cuando se tiene una variable cuantitativa.
