...
plot(x=x, y=x, main='Usando cex=1.4')

par(cex=0.6)
plot(x=x, y=x, main='Usando cex=0.6')
```
...
## Parámetro `cex.axis` \index{tamaño de los nombres en los ejes} \index{cex.axis}
...
plot(x=x, y=x,
     ...
     main='Usando cex.axis=1.4')

par(cex.axis=0.6)
plot(x=x, y=x,
     xlab='Valores de x', ylab='Valores de y',
     main='Usando cex.axis=0.6')
```
