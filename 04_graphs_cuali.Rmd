...
### Ejemplo {-}
Suponga que se tiene la información del número de hombres y mujeres que sufren de una enfermedad rara en cuatro ciudades importantes del mundo, a continuación la matriz `x` con la información recolectada.
...
```{r dotchart2, fig.cap='Ejemplos de los tipos de puntos obtenidos al variar `pch`.', fig.asp=0.5, fig.width=6, echo=TRUE}
dotchart(x=x)
```
