...
```{r qqplot1, fig.cap='Gráfico cuantil cuantil para una muestra generada de una población normal.', fig.asp=0.5, fig.width =7}
...
```{r qqplot2, fig.cap='Gráfico cuantil cuantil para una muestra generada de una población Weibull.', fig.asp=0.5, fig.width =7}
n <- 100
